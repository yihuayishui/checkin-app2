...
import com.checkin.partner.data.entity.NotificationEntity;
...
public final class NotificationDao_Impl implements NotificationDao {
  ...
  public NotificationDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNotificationEntity = new EntityInsertionAdapter<NotificationEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notification` (`id`,`user_id`,`type`,`title`,`body`,`related_id`,`is_read`,`created_at`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getRelatedId() == null) {
          ...
          statement.bindString(6, entity.getRelatedId());
        }
    ...
    this.__preparedStmtOfMarkAllRead = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE notification SET is_read = 1 WHERE user_id = ?";
        return _query;
      }
    };
  ...
  @Override
  public Object insertAll(final List<NotificationEntity> list,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        try {
          __insertionAdapterOfNotificationEntity.insert(list);
  ...
  public Object getByUserId(final String userId,
    ...
    final String _sql = "SELECT * FROM notification WHERE user_id = ? ORDER BY created_at DESC LIMIT 50";
    ...
    return CoroutinesRoom.execute(__db, false, _cancellationSignal, new Callable<List<NotificationEntity>>() {
      ...
      public List<NotificationEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfRelatedId = CursorUtil.getColumnIndexOrThrow(_cursor, "related_id");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpRelatedId;
            if (_cursor.isNull(_cursorIndexOfRelatedId)) {
              _tmpRelatedId = null;
            } else {
              _tmpRelatedId = _cursor.getString(_cursorIndexOfRelatedId);
            }
            ...
            _item = new NotificationEntity(_tmpId,_tmpUserId,_tmpType,_tmpTitle,_tmpBody,_tmpRelatedId,_tmpIsRead,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object unreadCount(final String userId, final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM notification WHERE user_id = ? AND is_read = 0";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, userId);
    final CancellationSignal _cancellationSignal = DBUtil.createCancellationSignal();
